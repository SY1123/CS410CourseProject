import styles from "./LyricsSearchArea.module.scss"
...
const { Search } = Input;
class LyricsSearchArea extends React.Component<{}, {searchResults: any[]},{item:any}> {
    constructor(props) {
        super(props);
        this.state = {
...
export default LyricsSearchArea