import styles from "./senti.module.scss"
...
const { Search } = Input;
class SentimentSearchArea extends React.Component<{}, {searchResults: any[]},{item:any}> {
    constructor(props) {
        super(props);
        this.state = {
    ...
    handleSearch(value : string){
        ...
        fetch("http://127.0.0.1:5000/sentiment_search?keyword="+searchTerm,{
            method:'GET',
            headers:{
    ...
    render(): ReactNode {
        return(
            <div className={styles.lyricsSearchArea} style={{marginTop: 30}}>
                ...
                <Divider plain>Search Results</Divider>
...
export default SentimentSearchArea